...
const TABLE = { "tf-clients": "clients", "tf-tasks": "tasks", "tf-pages": "pages", "tf-tags": "tags", "tf-meetings": "meetings", "tf-activity": "activity", "tf-users": "users" };
...
export default function App() {
  ...
  useEffect(() => {
    (async () => {
      const [sc, st, sp, stg, sm, sa, su] = await Promise.all([
